...
export const testimonialsData: testimonialDataType[] = [
...

  {
    ...
    name: 'Laura',
    city: 'Curitiba',
    avatarSrc: '/assets/testimonials/img1.jpg'
  },

  {
    text: 'A OneBitMusic realmente sabe como encantar seu público. Os shows digitais são uma experiência incrível, onde você se sente imerso na música e nos visuais deslumbrantes. A qualidade do áudio é excepcional e a interatividade da plataforma é de tirar o fôlego. Parabéns à OneBitMusic por proporcionar momentos musicais tão memoráveis.',
    name: 'Isabela',
    city: 'Florianópolis',
